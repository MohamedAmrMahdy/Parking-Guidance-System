...
public class Core {
    static void FirstRun() throws IOException{
        ...
        spot s = new spot();
        ticket t = new ticket();
        File fen = new File(AppSettings.EntryEmployeeFile);
        File fex = new File(AppSettings.ExitEmployeeFile);
        File fs = new File(AppSettings.SpotFile);
        ...
        alx = (ArrayList<Entry_Empolyee>) FM.read(AppSettings.EntryEmployeeFile);
        System.out.println(alx.get(0).getPassword());

        ArrayList<Exit_Empolyee> al = new ArrayList<Exit_Empolyee>();
        al = (ArrayList<Exit_Empolyee>) FM.read(AppSettings.ExitEmployeeFile);
